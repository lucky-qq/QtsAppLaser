 ...
 */
public class BoxBackActivity extends ParentReceiverActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.box_back);
    ...
    public void boxBackClick(View view) {
        if (uiBoxCode.getText().toString().length() != 11) {
            Toast.makeText(this, R.string.box_code_error, Toast.LENGTH_LONG).show();
            return;
        }
        if (!Box.STATE_IN_WAREHOUSE.equals(uiBoxState.getText().toString())) {
    ...
    public class LoadBoxInfo extends AsyncTask<Void, String, BoxWithBundle> {
        ...
        protected void onPostExecute(BoxWithBundle boxWithBundle) {
            ...
            if (boxWithBundle == null) {
                Toast.makeText(BoxBackActivity.this, R.string.box_code_error, Toast.LENGTH_LONG).show();
            } else {
                ...
                if(Box.STATE_IN_WAREHOUSE.equals(boxWithBundle.getState())) {
    ...
    public class BoxBack extends AsyncTask<Void, String, Boolean> {
        @Override
        protected void onPreExecute() {
            progressDialog.show();
        }
        ...
        protected Boolean doInBackground (Void... voids) {
            return QtsBiz.getInstance(getApplicationContext()).boxBackToCheck(uiBoxCode.getText().toString());
        }
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result) {
                ...
                uiBoxState.setText("");
                Toast.makeText(BoxBackActivity.this, R.string.box_back_success, Toast.LENGTH_LONG).show();
            } else {
                Toast.makeText(BoxBackActivity.this, R.string.box_back_fail, Toast.LENGTH_LONG).show();
            }
        }
    }
}